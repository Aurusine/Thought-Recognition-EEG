...
for i = 1:length(names)
    ...
    for ii = 1:3
        ...
        powerdiff_gamma(tablegen, :) = abs((power_gamma(tablegen, 1) - power_gamma(tablegen, 2))/(power_gamma(tablegen, 1) + power_gamma(tablegen, 2)));
        powerdiff_beta(tablegen, :) = abs((power_beta(tablegen, 1) - power_beta(tablegen, 2))/(power_beta(tablegen, 1) + power_beta(tablegen, 2)));
        powerdiff_alpha(tablegen, :) = abs((power_alpha(tablegen, 1) - power_alpha(tablegen, 2))/(power_alpha(tablegen, 1) + power_alpha(tablegen, 2)));
        powerdiff_theta(tablegen, :) = abs((power_theta(tablegen, 1) - power_theta(tablegen, 2))/(power_theta(tablegen, 1) + power_theta(tablegen, 2)));
        powerdiff_delta(tablegen, :) = abs((power_delta(tablegen, 1) - power_delta(tablegen, 2))/(power_delta(tablegen, 1) + power_delta(tablegen, 2)));
